...
#' @param organism organism of the fasta file. Default is "mouse". Other options are "human", "medicago_trucantula", "rhizobium_melitoli", "pig", "human_iso", "ecoli", "arabidopsis", "rat", "yeast", and "c_elegans". Each organism provides UniProt-curated protein processing annotations including signal peptides, transit peptides, propeptides, and mature protein chains.
...
#' @examples
#' \dontrun{
#' # Basic usage with mouse annotations
#' annotated_peptides <- annotate_neo_termini(
#'   peptides_df = my_peptides,
#'   fasta_location = "path/to/mouse_proteins.fasta",
#'   sense = "C",
#'   specificity = "K|R",
#'   organism = "mouse"
#' )
#' 
#' # Using C. elegans annotations
#' annotated_peptides_celegans <- annotate_neo_termini(
#'   peptides_df = my_peptides,
#'   fasta_location = "path/to/c_elegans_proteins.fasta",
#'   sense = "C",
#'   specificity = "K|R",
#'   organism = "c_elegans"
#' )
#' 
#' # Using human annotations with isoforms
#' annotated_peptides_human <- annotate_neo_termini(
#'   peptides_df = my_peptides,
#'   fasta_location = "path/to/human_proteins.fasta",
#'   sense = "C",
#'   specificity = "K|R",
#'   organism = "human_iso"
#' )
