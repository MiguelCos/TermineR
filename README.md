...
- <a href="#installation" id="toc-installation">Installation</a>
  - <a href="#requisites" id="toc-requisites">Requisites</a>
- <a href="#usage-at-a-glance" id="toc-usage-at-a-glance">Usage at a
  glance</a>
  - <a href="#adapter-functions" id="toc-adapter-functions">Adapter
    functions</a>
  - <a href="#peptide-annotation" id="toc-peptide-annotation">Peptide
    annotation</a>
  - <a href="#visualization-of-cleavage-sites"
    id="toc-visualization-of-cleavage-sites">Visualization of cleavage
    sites</a>
  - <a href="#differential-abundance-analysis"
    id="toc-differential-abundance-analysis">Differential abundance
    analysis</a>
- <a href="#minimal-example" id="toc-minimal-example">Minimal example</a>
- <a href="#extended-example" id="toc-extended-example">Extended
  example</a>
...
repository and need to be installed from Bioconductor. You can install
...
generated by the FragPipe search engine for a TMT experiment. Options
for label-free experiments will be added in the future.
...
will extract peptide-level quantitative information and perform
standardization of the intensities based on MAD scaling. Currently the
function does not support any N-terminal modifications, and these will
...
```
    ...
    here() starts at C:/Users/migue/OneDrive/Documentos/R_Projects/5_projects/nterminomics_semitryptic/TermineR
    ...
    Loading psm.tsv files...

    Loading annotation files...

    Filtering PSM files...

    Calculating reference scaling factors and normalizing...

    Calculating final scaled abundances...
...
```
    ...
    other attached packages:
     [1] pheatmap_1.0.12    RColorBrewer_1.1-3 tibble_3.2.1       ggplot2_3.5.0     
     [5] magrittr_2.0.3     seqinr_4.2-36      tidyr_1.3.1        stringr_1.5.1     
     [9] dplyr_1.1.4        purrr_1.0.2        readr_2.1.5        here_1.0.1        
    [13] TermineR_1.0.0    

    loaded via a namespace (and not attached):
     [1] utf8_1.2.4          generics_0.1.3      stringi_1.8.3      
     [4] hms_1.1.3           digest_0.6.33       RcppEigen_0.3.4.0.0
     [7] evaluate_0.23       grid_4.3.2          timechange_0.3.0   
    [10] fastmap_1.1.1       rprojroot_2.0.4     jsonlite_1.8.7     
    [13] fansi_1.0.6         scales_1.3.0        ade4_1.7-22        
    [16] cli_3.6.2           rlang_1.1.3         crayon_1.5.2       
    [19] munsell_0.5.0       bit64_4.0.5         withr_3.0.0        
    [22] yaml_2.3.8          tools_4.3.2         parallel_4.3.2     
    [25] tzdb_0.4.0          colorspace_2.1-0    vctrs_0.6.5        
    [28] R6_2.5.1            lifecycle_1.0.4     lubridate_1.9.3    
    [31] snakecase_0.11.1    bit_4.0.5           vroom_1.6.5        
    [34] MASS_7.3-60.0.1     janitor_2.2.0       pkgconfig_2.0.3    
    [37] pillar_1.9.0        gtable_0.3.4        data.table_1.14.8  
    [40] glue_1.7.0          Rcpp_1.0.12         xfun_0.40          
    [43] tidyselect_1.2.1    knitr_1.45          farver_2.1.1       
    [46] htmltools_0.5.7     labeling_0.4.3      rmarkdown_2.26     
    [49] diann_1.0.1         compiler_4.3.2     
